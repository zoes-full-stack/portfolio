...
//     function initLightbox(masonry, retries = 60) {
...
//         const panel = document.querySelector(".lb__panel");
//         const mediaBox = document.getElementById("lbMedia");
//         const controls = document.querySelector(".lb__controls");
//         if (!panel || !mediaBox || !item) return;
...
//         const maxW = vw - paddingW;
//         const controlsH = controls ? controls.offsetHeight : 0;
//         const maxH = vh - paddingH - controlsH;
...
//         const node = ensureLightboxInBody();
...
//           if (lb.getAttribute("aria-hidden") === "false" && lbCurrentItem) {
//             sizeLightboxToItem(lbCurrentItem);
//           }
//         }, { passive: true });

//         // mobile address-bar changes (optional but nice)
